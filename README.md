...
Built firmware has 6 files:
* dactyl_dongle-nice_nano_v2-zmk.uf2
* dactyl_dongle-seeeduino_xiao_ble-zmk.uf2
...
Make sure to flash the correct controller with the correct firmware. Flashing nice_nano firmware onto XIAO BLE might do bad things
